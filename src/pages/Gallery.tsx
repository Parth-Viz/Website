  ...
  return (
    <div className="min-h-screen bg-black font-poppins">
      ...
      <div className="relative z-10 pt-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center py-20">
            <h1 className="text-5xl font-bold text-white mb-6 drop-shadow-lg">Travel Gallery</h1>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 pb-20">
            {albums?.map((album) => {
              const coverImage = album.cover_image_url || `/images/travel/${album.location?.toLowerCase().replace(/\s+/g, '-')}.jpg`;
              return (
                <Link key={album.id} to={`/gallery/${album.id}`} className="group block">
                  <div className="bg-gray-900/80 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
