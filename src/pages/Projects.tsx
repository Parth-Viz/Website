...
import { ExternalLink, Github, Home, Code2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-black font-poppins">
      ...
      <div className="relative z-10 pt-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center py-20">
            <h1 className="text-5xl font-bold text-white mb-6 drop-shadow-lg">My Projects</h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 pb-20">
            {projects?.map((project) => (
              <div key={project.id} className="bg-gray-900/80 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
